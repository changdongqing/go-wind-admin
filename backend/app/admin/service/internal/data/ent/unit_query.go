...
type UnitQuery struct {
	...
	withCategory *UnitCategoryQuery
...
func (_q *UnitQuery) QueryCategory() *UnitCategoryQuery {
	query := (&UnitCategoryClient{config: _q.config}).Query()
...
func (_q *UnitQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *UnitQuery) FirstIDX(ctx context.Context) uint32 {
...
func (_q *UnitQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *UnitQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (_q *UnitQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (_q *UnitQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *UnitQuery) WithCategory(opts ...func(*UnitCategoryQuery)) *UnitQuery {
	query := (&UnitCategoryClient{config: _q.config}).Query()
...
func (_q *UnitQuery) prepareQuery(ctx context.Context) error {
	...
	if unit.Policy == nil {
		return errors.New("ent: uninitialized unit.Policy (forgotten import ent/runtime?)")
	}
	if err := unit.Policy.EvalQuery(ctx, _q); err != nil {
		return err
	}
	return nil
}
...
func (_q *UnitQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Unit, error) {
	...
	if query := _q.withCategory; query != nil {
		if err := _q.loadCategory(ctx, query, nodes, nil,
			func(n *Unit, e *UnitCategory) { n.Edges.Category = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *UnitQuery) loadCategory(ctx context.Context, query *UnitCategoryQuery, nodes []*Unit, init func(*Unit), assign func(*Unit, *UnitCategory)) error {
	ids := make([]uint32, 0, len(nodes))
	nodeids := make(map[uint32][]*Unit)
	for i := range nodes {
...
func (_q *UnitQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(unit.Table, unit.Columns, sqlgraph.NewFieldSpec(unit.FieldID, field.TypeUint32))
	_spec.From = _q.sql
...
func (_q *UnitQuery) ForUpdate(opts ...sql.LockOption) *UnitQuery {
...
func (_q *UnitQuery) ForShare(opts ...sql.LockOption) *UnitQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
...
func (_q *UnitQuery) Modify(modifiers ...func(s *sql.Selector)) *UnitSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *UnitSelect) Modify(modifiers ...func(s *sql.Selector)) *UnitSelect {
