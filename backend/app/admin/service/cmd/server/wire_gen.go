...
func initApp(context *bootstrap.Context) (*kratos.App, func(), error) {
	...
	unitCategoryRepo := data.NewUnitCategoryRepo(context, entClient)
	unitCategoryService := service.NewUnitCategoryService(context, unitCategoryRepo)
	...
	categoryDefaultFeatureService := service.NewCategoryDefaultFeatureService(context, categoryDefaultFeatureRepo, categoryRepo, featureRepo, unitRepo)
	productRepo := data.NewProductRepo(context, entClient)
	productService := service.NewProductService(context, productRepo, categoryRepo)
	productFeatureRepo := data.NewProductFeatureRepo(context, entClient)
	productFeatureService := service.NewProductFeatureService(context, productFeatureRepo, productRepo, featureRepo, unitRepo, categoryDefaultFeatureRepo)
