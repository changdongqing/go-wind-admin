...
var File_admin_service_v1_i_feature_proto protoreflect.FileDescriptor

const file_admin_service_v1_i_feature_proto_rawDesc = "" +
	"\n" +
	" admin/service/v1/i_feature.proto\x12\x10admin.service.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1epagination/v1/pagination.proto\x1a#thingmodel/service/v1/feature.proto2\xa2\b\n" +
	...
	"\x06Create\x12+.thingmodel.service.v1.CreateFeatureRequest\x1a\x16.google.protobuf.Empty\"(\x82\xd3\xe4\x93\x02\":\x01*\"\x1d/admin/v1/thingmodel/features\x12|\n" +
	"\x06Update\x12+.thingmodel.service.v1.UpdateFeatureRequest\x1a\x16.google.protobuf.Empty\"-\x82\xd3\xe4\x93\x02':\x01*\x1a\"/admin/v1/thingmodel/features/{id}\x12t\n" +
	...
	"\n" +
	"ListByType\x12/.thingmodel.service.v1.ListFeatureByTypeRequest\x1a*.thingmodel.service.v1.ListFeatureResponse\":\x82\xd3\xe4\x93\x024\x122/admin/v1/thingmodel/features/types/{feature_type}\x12\x9e\x01\n" +
...
var file_admin_service_v1_i_feature_proto_goTypes = []any{
	...
	(*v11.GetFeatureRequest)(nil),        // 1: thingmodel.service.v1.GetFeatureRequest
	(*v11.CreateFeatureRequest)(nil),     // 2: thingmodel.service.v1.CreateFeatureRequest
	(*v11.UpdateFeatureRequest)(nil),     // 3: thingmodel.service.v1.UpdateFeatureRequest
	...
	(*v11.ImportFeaturesRequest)(nil),    // 6: thingmodel.service.v1.ImportFeaturesRequest
	...
	(*v11.ImportFeaturesResponse)(nil),   // 10: thingmodel.service.v1.ImportFeaturesResponse
}
var file_admin_service_v1_i_feature_proto_depIdxs = []int32{
	...
	1,  // 1: admin.service.v1.FeatureService.Get:input_type -> thingmodel.service.v1.GetFeatureRequest
	2,  // 2: admin.service.v1.FeatureService.Create:input_type -> thingmodel.service.v1.CreateFeatureRequest
	3,  // 3: admin.service.v1.FeatureService.Update:input_type -> thingmodel.service.v1.UpdateFeatureRequest
	...
	6,  // 6: admin.service.v1.FeatureService.ImportFeatures:input_type -> thingmodel.service.v1.ImportFeaturesRequest
	...
	10, // 13: admin.service.v1.FeatureService.ImportFeatures:output_type -> thingmodel.service.v1.ImportFeaturesResponse
...
func init() { file_admin_service_v1_i_feature_proto_init() }
func file_admin_service_v1_i_feature_proto_init() {
	if File_admin_service_v1_i_feature_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_admin_service_v1_i_feature_proto_rawDesc), len(file_admin_service_v1_i_feature_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_admin_service_v1_i_feature_proto_goTypes,
		DependencyIndexes: file_admin_service_v1_i_feature_proto_depIdxs,
	}.Build()
	File_admin_service_v1_i_feature_proto = out.File
	file_admin_service_v1_i_feature_proto_goTypes = nil
	file_admin_service_v1_i_feature_proto_depIdxs = nil
}
