...
func RegisterPositionServiceHTTPServer(s *http.Server, srv PositionServiceHTTPServer) {
	r := s.Route("/")
	r.GET("/admin/v1/positions", _PositionService_List19_HTTP_Handler(srv))
...
func _PositionService_List19_HTTP_Handler(srv PositionServiceHTTPServer) func(ctx http.Context) error {
