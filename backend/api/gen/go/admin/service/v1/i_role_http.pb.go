...
func RegisterRoleServiceHTTPServer(s *http.Server, srv RoleServiceHTTPServer) {
	...
	r.PUT("/admin/v1/roles/{id}", _RoleService_Update17_HTTP_Handler(srv))
	r.DELETE("/admin/v1/roles/{id}", _RoleService_Delete17_HTTP_Handler(srv))
}
...
func _RoleService_Update17_HTTP_Handler(srv RoleServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _RoleService_Delete17_HTTP_Handler(srv RoleServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
