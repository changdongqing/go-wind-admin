...
func RegisterUserServiceHTTPServer(s *http.Server, srv UserServiceHTTPServer) {
	...
	r.POST("/admin/v1/users", _UserService_Create22_HTTP_Handler(srv))
	r.PUT("/admin/v1/users/{id}", _UserService_Update22_HTTP_Handler(srv))
...
func _UserService_Create22_HTTP_Handler(srv UserServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _UserService_Update22_HTTP_Handler(srv UserServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
