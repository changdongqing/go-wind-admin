...
func _FeatureService_Get8_HTTP_Handler(srv FeatureServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _FeatureService_Get9_HTTP_Handler(srv FeatureServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in v11.GetFeatureRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
