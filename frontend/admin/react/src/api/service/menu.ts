...
export async function createMenu(request: permissionservicev1_CreateMenuRequest) {
  return getMenuService().Create(request);
}

export async function updateMenu(request: permissionservicev1_UpdateMenuRequest) {
  return getMenuService().Update(request);
}

export async function deleteMenu(request: permissionservicev1_DeleteMenuRequest) {
